...
const name = document.getElementsByClassName("input-with-validator");
const inputName = name[0].querySelector("input");
  ...
  xhttp.onreadystatechange = function () {
    if (this.readyState == 4 && this.status == 200) {
      ...
      if (pulling) {
        ...
        console.log(
          `%c${inputName.value} đã dùng: ${moneyFormat(totalSpent)} đ`
        );
        console.log(
